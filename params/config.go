...
var (
	MainnetGenesisHash = common.HexToHash("0x9e6f260b1141f5709beda74eae3e0ecd97ad2a0317d867bac7f9e46b199a9dae")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		DarvazaDefaultGas:   new(big.Int).SetUint64(20 * Shannon),
	...
	TestnetChainConfig = &ChainConfig{
		...
		DarvazaBlock:        big.NewInt(0),
		DarvazaDefaultGas:   new(big.Int).SetUint64(20 * Shannon),
		HafthorBlock:        big.NewInt(0),                                            // 2022-01-15
	...
	AllCliqueProtocolChanges = &ChainConfig{ChainId: big.NewInt(1090), HomesteadBlock: big.NewInt(0),
	...
	TestChainConfig = &ChainConfig{ChainId: big.NewInt(1190), HomesteadBlock: big.NewInt(0),
		EIP150Block: big.NewInt(0), EIP155Block: big.NewInt(0), EIP158Block: big.NewInt(0),
