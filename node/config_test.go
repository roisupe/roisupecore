...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "roisupe.ipc", false, filepath.Join(os.TempDir(), "roisupe.ipc")},
		{"data", "roisupe.ipc", false, "data/roisupe.ipc"},
		{"data", "./roisupe.ipc", false, "./roisupe.ipc"},
		{"data", "/roisupe.ipc", false, "/roisupe.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "roisupe.ipc", true, `\\.\pipe\roisupe.ipc`},
		{"data", "roisupe.ipc", true, `\\.\pipe\roisupe.ipc`},
		{"data", `\\.\pipe\roisupe.ipc`, true, `\\.\pipe\roisupe.ipc`},
	}
